...
import bgUrl from "../assets/aluzar8.webp";
...
export default function Contact({ whatsappNumber }) {
  ...
  return (
    <Box
      ...
      overflow="hidden"
    >
      <Box position="absolute" inset={0} bg="rgba(0,0,0,0.62)" zIndex={1} />
      ...
      >
        ...
        >
          ...
          <Text
            ...
            mb={10}
          >
            Marca uma prova com o nosso fundador.
            <br />
        ...
        >
          {/* WhatsApp icon */}
          <Box as="svg" w="22px" h="22px" viewBox="0 0 24 24" fill="white" flexShrink={0}>
